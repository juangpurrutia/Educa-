...
export default function CentralAltter({ navigation }: Props) {
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
            {
                ...
                <View style={{ backgroundColor: 'white', width: '100%' }}>
                    <View style={{ paddingHorizontal: 20, paddingTop: 20 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 20 }}>Central - Editar Curso</Text>
                ...
                <View style={{ flex: 1, backgroundColor: 'white', alignItems: 'center', width: '100%' }}>   
                    ...
                    {/* Imagem */}
                    <Image source={require('../../../../../assets/ideia_logo1.png')} style={{ width: '100%', height: 100, marginTop: 20 }} resizeMode="contain" />
                    ...
                    <View style={{ width: '80%', marginTop: 20 }}>
                        ...
                        <TextInput placeholder="Curso" style={{ borderWidth: 1, borderColor: '#ccc', padding: 10, marginBottom: 10, borderRadius: 5 }} />
                ...
                <View style={{ backgroundColor: 'black', width: '100%' }}>
                    <View style={{ paddingHorizontal: 20, paddingTop: 20 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 20, color: "white" }}>Central - Editar Curso</Text>
                        <View style={{ height: 1, backgroundColor: '#fcc42c', marginTop: 10 }} />
                    </View>
                </View>
                <View style={{ flex: 1, backgroundColor: 'black', alignItems: 'center', width: '100%' }}>   
                    ...
                    {/* Imagem */}
                    <Image source={require('../../../../../assets/ideia_logo_lampada_1.png')} style={{ width: '100%', height: 100, marginTop: 20 }} resizeMode="contain" />
                    ...
                    <View style={{ width: '80%', marginTop: 20 }}>
                        ...
                        <TextInput placeholder="Curso" placeholderTextColor="#d6d6d6" style={{ borderWidth: 1, borderColor: '#ccc', padding: 10, marginBottom: 10, borderRadius: 5 }} />
